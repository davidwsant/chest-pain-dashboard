...
d3.select(window).on('load', () => {
    ...
    column2.append('img')
        ...
        .attr('src', 'Images/george-dubbayuh-ecg.jpg')
        .attr('height', '0px')
        .attr('width', '0px')
...
function scoreColumn2 () {
    ...
    d3.select('#colum2Line1').text('HEART Score: 5')
    ...
    d3.select('#colum2Line4').text('History: Slightly Suspicious (+0)').attr('fill', 'black').on('click', () => {})
...
function cathColumn2 () {
    ...
    d3.select('#colum2Line5').text("PROCEDURE OPERATOR: Chick Daney")
    d3.select('#colum2Line6').text("ATTENDING PHYSICIAN: In Attendance (Y)")
    d3.select('#colum2Line8').text("CONSENT:")
    d3.select('#colum2Line9').attr('fill', 'black').on('click', ()=> {}).text("Consent was obtained from Curious George Dubbayuh prior to the procedure. ")
    d3.select('#colum2Line10').text("Indications, risks, and  benefits were explained at length. The procedure was performed ")
    d3.select('#colum2Line11').text("emergently and the  permission was implied because of the emergent nature.")
    ...
    d3.select('#colum2Line15').text("observer (Baura Lush) starting with the first handwash prior to starting sterile")
...
function echoColumn2() {
    ...
    d3.select('#colum2Line11').text("CHICK DENEY, RN - 06/23/2018 10:29 MDT")
    ...
    d3.select('#colum2Line17').text("Performed by:	    CHICK DENEY, RN on June 3, 2018 10:29 MDT")
    d3.select('#colum2Line18').text("Verified by:	    CHICK DENEY, RN on June 3, 2018 10:29 MDT")
...
function cardioColumn2 () {
    ...
    d3.select('#colum2Line7').text("PRIMARY CARE PHYSICIAN: Gal Ore")
...
function dischargeColumn2 () {
    ...
    d3.select('#colum2Line39').text("Gal Ore in 1 to 2 weeks. He will also follow up with his primary care physician, ")
