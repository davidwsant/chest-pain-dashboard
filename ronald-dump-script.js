...
d3.select(window).on('load', () => {
    ...
    heartScoreGroup.append('text')
        ...
        .text('High risk of Major Adverse Cardiac Event')
        .style('font-size', '20px')
    ...
    column2.append('img')
        ...
        .attr('src', 'Images/ronald-dump-ecg.jpg')
        .attr('height', '0px')
        .attr('width', '0px')
...
function scoreColumn2 () {
    ...
    d3.select('#colum2Line1').text('HEART Score: 7')
    d3.select('#colum2Line2').text('High risk of Major Adverse Cardiac Event')
    d3.select('#colum2Line3').text('50-65% risk of Adverse Cardiac Event')
    ...
    d3.select('#colum2Line7').text('Risk Factors: Diabetes Mellitus, Obesity, Hypercholesterolemia (+2)')
...
function pathwayColumn2 () {
    ...
    d3.select('#colum2Line2').text('High Risk')
...
function cathColumn2 () {
    ...
    d3.select('#colum2Line5').text("PROCEDURE OPERATOR: Padamit Vutin")
    d3.select('#colum2Line6').text("ATTENDING PHYSICIAN: In Attendance (Y)")
    d3.select('#colum2Line8').text("CONSENT:")
    d3.select('#colum2Line9').attr('fill', 'black').on('click', ()=> {}).text("Consent was obtained from Ronald Dump prior to the procedure. Indications, risks, and ")
    ...
    d3.select('#colum2Line15').text("observer (Kim Jong Fat Boy) starting with the first handwash prior to starting sterile")
    ...
    d3.select('#colum2Line35').text("blood loss is 250 mL.")
...
function echoColumn2() {
    ...
    d3.select('#colum2Line11').text("MELANIA RUMP, RN - 06/23/2018 10:29 MDT")
    ...
    d3.select('#colum2Line17').text("Performed by:	    MELANIA RUMP, RN on June 3, 2018 10:29 MDT")
    d3.select('#colum2Line18').text("Verified by:	    MELANIA RUMP, RN on June 3, 2018 10:29 MDT")
...
function cardioColumn2 () {
    ...
    d3.select('#colum2Line7').text("PRIMARY CARE PHYSICIAN: Ivanka Yakalot")
...
function dischargeColumn2 () {
    ...
    d3.select('#colum2Line19').text("HISTORY OF PRESENT ILLNESS:  This 74-year-old male with no previous history of heart ")
    ...
    d3.select('#colum2Line39').text("Fiedel Castrate in 1 to 2 weeks. He will also follow up with his primary care physician, ")
